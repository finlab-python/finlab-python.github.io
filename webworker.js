...
async function loadPyodideAndPackages() {
  ...
  try {
    ...
    await self.pyodide.loadPackage(['micropip', 'pandas', 'jinja2', 'requests']);
    ...
    await self.pyodide.loadPackage(['/pyodide/TA_Lib-0.4.26-cp311-cp311-emscripten_3_1_46_wasm32.whl']);
